...
sudo apt-get update
sudo apt-get install -y libffi-dev libportaudio2 portaudio19-dev python3-dev libopenblas-dev libsdl2-mixer-2.0-0 libsdl2-ttf-2.0-0
...
echo "⬇️ Downloading TFLite Models..."
